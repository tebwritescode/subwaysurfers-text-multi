...
- `/Users/dev/Documents/Projects/claude-code/subwaysurfers-text-multi/integration_test.py`
- `/Users/dev/Documents/Projects/claude-code/subwaysurfers-text-multi/integration_test_output/` (test results and audio samples)
- `/Users/dev/Documents/Projects/claude-code/subwaysurfers-text-multi/voice_samples/` (Bark voice samples)
